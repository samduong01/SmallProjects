...
public class Board {
        ...
        for (int i = 0; i < board.length; i++) {
            for (int j = 0; j < board[0].length; j++) {
                if (count == 0 && board[i][j].equals(type)) {
                    cords[0][0] = i;
                    cords[0][1] = j;
                    System.out.println("inside double for loop towInARow horizontal: ");
                    count++;
                }else if (count == 1 && board[i][j].equals(type)) {
                    System.out.println("there is a second spot with type in horizontal");
            ...
            for (int i = 0; i < board.length; i++) {
                for (int j = 0; j < board[0].length; j++) {
                    if (count == 0 && board[j][i].equals(type)) {
                        ...
                        System.out.println("second type occurs in vertical");
                        cords[1][0] = i;
                        cords[1][1] = j;
                        if (cords[1][1] - cords[0][1] == 2) {
                            System.out.println("in if statement vertical #0: " + fillCords[0][0]);
                            System.out.println("in if statement vertical #0: " + fillCords[0][1]);
                            fillCords[0][1] = cords[1][0];
                            fillCords[0][0] = 1;
                        } else if (cords[1][1] == 2 && cords[0][1] == 1) {
                            System.out.println("in if statement vertical #1: " + fillCords[0][0]);
                            fillCords[0][1] = cords[0][0];
                            fillCords[0][0] = 0;
                        } else {
                            fillCords[0][1] = cords[1][0];
                            fillCords[0][0] = 2;
                            System.out.println("in if statement vertical #2: " + fillCords[0][1]);
                        }

                        if(board[fillCords[0][0]][fillCords[0][1]].equals(" ")) {
                            System.out.println(" " + fillCords[0][0] + " " + fillCords[0][1]);
                            System.out.println("vertical good to go");
                            return true;
                        }else{
                            System.out.println("vertical not good to go");
                            fillCords[0][0] = 10;
                            fillCords[0][1] = 10;
                            return false;
                        }
            ...
            for (int i = 0; i < board.length; i++) {
                for (int j = 0; j < board[0].length; j++) {
                    if (count == 0 && board[i][j].equals(type)&& i == j) {
                        ...
                        System.out.println("second type occurs in diagonal");
                        cords[1][0] = i;
                        cords[1][1] = j;
                        ...
                        if(board[fillCords[0][0]][fillCords[0][1]].equals(" ")) {
                            System.out.println("in if statement diagonal right to left #1: " + fillCords[0][0]);
                            System.out.println("in if statement diagonal right to left #2: " + fillCords[0][1]);
                            return true;
                        }else{
                            fillCords[0][0] = 10;
                            fillCords[0][1] = 10;
            ...
            for (int i = 0; i < board.length; i++) {
                for (int j = 0; j < board[0].length; j++) {
                    if (count == 0 && board[i][j].equals(type)&& ((i == 0 && j == 2) || (i == 1 && j == 1) || (i == 2 && j == 0))) {
                        ...
                        System.out.println("second type occurs in diagonal #2");
                        cords[1][0] = i;
                        cords[1][1] = j;
                        if (cords[1][1] - cords[0][1] == 2 && cords[1][0] - cords[0][0] == 2) {
                            fillCords[0][1] = 1;
                        ...
                        if(board[fillCords[0][0]][fillCords[0][1]].equals(" ")) {
                            System.out.println("in if statement diagonal left to right #1: " + fillCords[0][0]);
                            System.out.println("in if statement diagonal left to right #2: " + fillCords[0][1]);
                            return true;
                        }else{
                            fillCords[0][0] = 10;
                            fillCords[0][1] = 10;
        ...
        for(int i = 0; i<board.length; i++){
            for(int j = 0; j<board[0].length;j++){
                if(((i == 0 && j == 0)||(i == 0 && j == 2)||(i == 2 && j == 0)||(i == 2 && j == 2)) && board[i][j].equals("X") ){
                    fillCords[0][0] = 1;
                    fillCords[0][1] = 1;
                    System.out.println("inside cornerCase");
                    if(board[fillCords[0][0]][fillCords[0][1]].equals(" ")){
                        return true;
                    }
                    return false;
    ...
    public void AI() {
        ...
        if(fillCords[0][0] == 10 || fillCords[0][1] == 10 || cords[0][0] == 10 || cords[1][0] == 10){
            System.out.println("fillcords = 10");
            if(doubleProng()){
                doubleProng();
            }else if(cornerCase()){
                cornerCase();
        ...
        System.out.println(" " + cords[0][0] + " " + cords[0][1] + " " + cords[1][0] + " " + cords[1][1]);
        System.out.println(fillCords[0][0] + " " + fillCords[0][1]);
        fillBoard(fillCords[0][1],fillCords[0][0], 1);
    }
}
