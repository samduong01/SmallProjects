Introduction:
    ...
    also has two stub classes which are TruthAssignment and LogicalSentence which are to be used later on.
...
It also has the two stub classes called TruthAssignment and LogicalSentence.

Classes to look at: TestPropositionConstant, PropositionConstant, LogicalSentence, and TruthAssignment.
